...
#ifndef BUOYANT_THERMAL_PROCESSOR_3Dv2_H
#define BUOYANT_THERMAL_PROCESSOR_3Dv2_H
...
template< typename T,
        ...
        >
class BuoyanTermProcessor3Dv2 :
    public BoxProcessingFunctional3D_LL<T,FluidDescriptor,T,TemperatureDescriptor>
{
public:

    BuoyanTermProcessor3Dv2(T gravity_, T rho0_, T rhoP_,
    ...
    virtual BuoyanTermProcessor3Dv2<T,FluidDescriptor,TemperatureDescriptor>* clone() const;
