...
#ifndef COUPLING_PROCESSOR_3D_H
#define COUPLING_PROCESSOR_3D_H
...
public:
    ...
    virtual CouplingProcessor3D<T,FluidDescriptor,DensityDescriptor>* clone() const;
