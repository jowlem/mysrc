...
#ifndef BUOYANT_THERMAL_PROCESSOR_3D_H
#define BUOYANT_THERMAL_PROCESSOR_3D_H
...
template< typename T,
        ...
        >
class BuoyanTermProcessor3D :
    public BoxProcessingFunctional3D_LL<T,FluidDescriptor,T,TemperatureDescriptor>
{
public:
    
    BuoyanTermProcessor3D(T gravity_, T rho0_, T rhoP_, T Vs_,
    ...
    virtual BuoyanTermProcessor3D<T,FluidDescriptor,TemperatureDescriptor>* clone() const;
    
private:
    T gravity, rho0, rhoP, Vs;
