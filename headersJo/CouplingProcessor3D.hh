...
#ifndef COUPLING_PROCESSOR_3D_HH
#define COUPLING_PROCESSOR_3D_HH

#include "CouplingProcessor3D.h"
...
template< typename T,
        ...
        >
CouplingProcessor3D<T,FluidDescriptor,DensityDescriptor>::
        CouplingProcessor3D()
{
...
template< typename T,
          ...
          template<typename U2> class DensityDescriptor
        >
void CouplingProcessor3D<T,FluidDescriptor,DensityDescriptor>::process (
        Box3D domain,
...
template< typename T,
        ...
        >
CouplingProcessor3D<T,FluidDescriptor,DensityDescriptor>*
    CouplingProcessor3D<T,FluidDescriptor,DensityDescriptor>::clone() const
{
    return new CouplingProcessor3D<T,FluidDescriptor,DensityDescriptor>(*this);
}
